...
| `mergify_cli_version` | no | `latest` | Version of `mergify-cli` to install. Pin an exact release (e.g. `2026.5.5.4`), or use `latest` (or leave unset) to install the latest released version. |
